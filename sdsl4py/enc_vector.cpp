...
void enc_vector_wrapper(py::module &m){
    ...
    add_enc_vector<enc_vector<sdsl::coder::elias_delta, 128, 0>>(m, "enc_vector_elias_delta");
    add_enc_vector<enc_vector<sdsl::coder::elias_gamma, 128, 0>>(m, "enc_vector_elias_gamma");
    add_enc_vector<enc_vector<sdsl::coder::fibonacci, 128, 0>>(m, "enc_vector_fibonacci");
    add_enc_vector<enc_vector<sdsl::coder::comma<2>, 128, 0>>(m, "enc_vector_comma_2");
}
